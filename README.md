...
_Matrix sweep in progress; see `outputs/benchmark/policy_matrix.md`._
<!-- POLICY_MATRIX:END -->
...
metrics across all traces) and the Python reference engine (exact agreement on SDSC FIFO). The
